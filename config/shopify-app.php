...
return [
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,read_orders,write_orders,read_all_orders'),
    ...
    */
    ...
    'webhooks' => [
            ...
            [
                'topic' => 'orders/create',
                'address' => 'https://phpstack-176572-1479735.cloudwaysapps.com/webhook/orders-create'
            ],
