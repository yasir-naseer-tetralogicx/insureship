...
<?php $__env->startSection('content'); ?>
            ...
            <div class="col-md-12">
                ...
                <div class="row my-3">
                    ...
                    <div class="claim-details col-6 text-right">
                        Claim Number: <span><?php echo e($order->fulfillments ? $order->tracking : '............'); ?> </span>
                    </div>
                </div>
                ...
                <div class="claim-info">
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <span>Buyers / Recipients Name: </span><input type="text" disabled value="<?php echo e($order['shipping_address'] ? $order->name : ''); ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-6">
                            <span>Street Address / PO Box: </span><input type="text" disabled value="<?php echo e($order['shipping_address'] ? $order->address : ''); ?>">
                        </div>

                        <div class="col-6">
                            <span>City: </span><input type="text" disabled value="<?php echo e($order['shipping_address'] ? $order->city : ''); ?>">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-4">
                            <span>State/Province: </span><input type="text" disabled  value="<?php echo e($order['shipping_address'] ? $order->province : ''); ?>">
                        </div>

                        <div class="col-4">
                            <span>Postal/Zip Code: </span><input type="text" disabled  value="<?php echo e($order['shipping_address'] ? $order->zip : ''); ?>">
                        </div>

                        <div class="col-4">
                            <span>Country: </span><input type="text" disabled  value="<?php echo e($order['shipping_address'] ? $order->country : ''); ?>">
                        </div>
                    </div>

                    <div class="row mb-3">
                        <div class="col-6">
                            <span>Email </span><input type="text" disabled value="<?php echo e($order['shipping_address'] ? $order->email : ''); ?>">
                        </div>
                        <div class="col-6">
                            <span>Phone: </span><input type="text" disabled  value="<?php echo e($order['shipping_address'] ? $order->phone : ''); ?>">
                        </div>
	...
	<div class="row bg-white p-2 mt-5">
	   <div class="col-md-12">
		<h4><u>Invoice</u></h4>
		<h5><u>Order Date:</u> <i><?php echo e($order->date); ?></i></h5>
		
		<?php if($order->line_items_count >0): ?>
                    <table class="table table-striped table-vcenter">
                       <thead>
                          <tr>
                              ...
                              <tbody>
                                <?php echo e($order->line_item_details); ?>
        ...
        <div class="col-6">
            ...
            <h5>Buyers / Recipients Name: <?php echo e($order['shipping_address'] ? $order->name : ''); ?></h5>
            <h5>Phone: <?php echo e($order['shipping_address'] ? $order->phone : ''); ?></h5>
            <h5>Street Address / PO Box: <?php echo e($order['shipping_address'] ? $order->address : ''); ?></h5>
            <h5>City: <?php echo e($order['shipping_address'] ? $order->city : ''); ?></h5>
            <h5>Zip: <?php echo e($order['shipping_address'] ? $order->zip : ''); ?></h5>
            <h5>Country: <?php echo e($order['shipping_address'] ? $order->country : ''); ?></h5>
        </div>
        <div class="col-6 text-right">
            <h5>Sub Total: <u>$<?php echo e($order->sub_total); ?></u></h5>
 	    <h5>Shipping Fee: <u>$<?php echo e($order->shipping_fee); ?></u></h5>
            <h5>Total:<u>$<?php echo e($order->total); ?></u></h5>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/176572.cloudwaysapps.com/anmqynzwwp/public_html/resources/views/pdf.blade.php ENDPATH**/ ?>