...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container mt-3">
		...
		<div class="col-12 text-right">
                	<button type="button" onclick="pdf('pdf')"  class="btn btn-danger float-right" value="">Download PDF</button>
		</div>
        </div>
	<div id="pdf">
        <div class="row bg-white p-2 mb-5">
            <div class="col-md-12">
                ...
                <div class="claim-info">
                    ...
                    <div class="row mb-3">
			<div class="col-6">
                            <span>Email </span><input type="text" value="<?php echo e($order['shipping_address'] ? $order->email : ''); ?>">
                        </div>
                        <div class="col-6">
                ...
                <div class="seller-info">
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <span>Name: </span><input type="text" value="OTC SHOPPE EXPRESS">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-6">
                            <span>Phone: </span><input type="text" value="+1 (619) 880-0429">
                        </div>

                        <div class="col-6">
                            <span>Email: </span><input type="text" value="HELLO@OTCSHOPPEEXPRESS.COM">
                        </div>
                    </div>
	...
	<br><br><br><br>
        <div class="row bg-white p-2 mt-5 p-5">
	   <div class="col-md-12">
		<h4><u>Invoice</u></h4>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/176572.cloudwaysapps.com/anmqynzwwp/public_html/resources/views/insurence-form.blade.php ENDPATH**/ ?>