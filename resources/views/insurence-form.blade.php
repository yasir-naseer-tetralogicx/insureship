        ...
        <div class="row bg-white p-2 mb-5">
            <div class="col-md-12">
                ...
                <div class="claim-info">
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <span>Buyers / Recipients Name: </span><input type="text" value="{{ $order['shipping_address'] ? $order->name : '' }}">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-6">
                            <span>Street Address / PO Box: </span><input type="text" value="{{ $order['shipping_address'] ? $order->address : '' }}">
                        </div>

                        <div class="col-6">
                            <span>City: </span><input type="text" value="{{ $order['shipping_address'] ? $order->city : '' }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-4">
                            <span>State/Province: </span><input type="text" value="{{ $order['shipping_address'] ? $order->province : '' }}">
                        </div>

                        <div class="col-4">
                            <span>Postal/Zip Code: </span><input type="text" value="{{ $order['shipping_address'] ? $order->zip : '' }}">
                        </div>

                        <div class="col-4">
                            <span>Country: </span><input type="text" value="{{ $order['shipping_address'] ? $order->country : '' }}">
                        </div>
                    </div>

                    <div class="row mb-3">
			<div class="col-6">
                            <span>Email </span><input type="text" value="{{ $order['shipping_address'] ? $order->email : '' }}">
                        </div>
                        <div class="col-6">
                            <span>Phone: </span><input type="text" value="{{ $order['shipping_address'] ? $order->phone : '' }}">
                        </div>
